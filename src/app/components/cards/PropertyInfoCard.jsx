    ...
    <div className="flex flex-col gap-2 p-4">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-2">
          ...
          <div className="flex items-start gap-1">
            ...
            />
            <p className="text-sm text-[#3d4578]">12 Bangui Street, Abuja.</p>
          </div>
        </div>
      ...
      <div className="mt-2">
        <p className="text-[#404b82] text-sm leading-6">
          ...
          beside airport Abuja, features a spacious living room, dining area,
          fitted kitchen, all rooms en-suite, a BQ, parking space <br /> Note:
          very close to abuja airport.
        </p>
      </div>
    </div>
  );
